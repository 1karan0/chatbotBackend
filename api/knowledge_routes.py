...
async def add_url_source(
    ...
    """Add a URL as a knowledge source and process it. Set force_playwright=true for React/Next.js sites."""
    ...
    try:
        result = await web_scraper.scrape_url(url, force_playwright=force_playwright)
